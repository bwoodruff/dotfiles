...
# When 1, fetch origin at startup; if behind, git pull --ff-only and re-exec this script.
DOTFILES_AUTO_UPDATE="${DOTFILES_AUTO_UPDATE:-1}"
# Compare remote URL to this GitHub "org/repo" (set DOTFILES_SELF_UPDATE_ANY_ORIGIN=1 to skip the check)
DOTFILES_UPSTREAM_GITHUB="${DOTFILES_UPSTREAM_GITHUB:-bwoodruff/dotfiles}"
DOTFILES_SELF_UPDATE_ANY_ORIGIN="${DOTFILES_SELF_UPDATE_ANY_ORIGIN:-0}"
...
ONEPASSWORD_SAFARI_INSTALLED_THIS_RUN=0
MAS_APP_STORE_SIGNIN_NEXT_STEP=0
ALFRED_INSTALLED_THIS_RUN=0
